...
import com.athena.stadium.rest.domain.StadiumDTO;
 ...
 */
@RestController
@RequestMapping(value = "/restdoc", produces = StadiumUtil.APPLICATION_JSON_UTF8)
public class RestDocController {
    ...
    public String objParam(@RequestBody StadiumDTO dto) {
