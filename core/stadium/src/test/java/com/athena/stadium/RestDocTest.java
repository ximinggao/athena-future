...
@SpringApplicationConfiguration(classes = {StadiumApplication.class})
@WebAppConfiguration
public class RestDocTest {

    @Rule
    public final RestDocumentation restDocumentation = new RestDocumentation("core/stadium/build/generated-snippets");
